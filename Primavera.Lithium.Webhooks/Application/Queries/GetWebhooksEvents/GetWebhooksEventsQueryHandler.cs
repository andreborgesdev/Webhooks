...
namespace Primavera.Lithium.Webhooks.Application
{
    ...
    /// </summary>
    public class GetWebhooksEventsQueryHandler : IRequestHandler<GetWebhooksEventsQuery, IEnumerable<WebhooksEvent>>
    {
        ...
        private ILogger<GetWebhooksEventsQueryHandler> Logger { get; set; }

        #endregion

        /// <summary>
        /// Initializes a new instance of the <see cref="GetWebhooksEventsQueryHandler"/> class.
        /// </summary>
        /// <param name="serviceProvider">asd</param>
        /// <param name="logger">asds</param>
        public GetWebhooksEventsQueryHandler(IServiceProvider serviceProvider, ILogger<GetWebhooksEventsQueryHandler> logger)
        {
        ...
        public async Task<IEnumerable<WebhooksEvent>> Handle(GetWebhooksEventsQuery request, CancellationToken cancellationToken)
        {
            SmartGuard.NotNull(() => request, request);

            return await this.table.RetrieveEntitiesAsync<WebhooksEvent>().ConfigureAwait(false);
        }
